...
static cl_int queue_metro_kernel(struct __clState *clState, struct _dev_blk_ctx *blk, __maybe_unused cl_uint threads)
{
  cl_kernel *kernel = &clState->kernel;
  unsigned int num = 0;
  cl_int status = 0;
...
#undef A_DARK
  ...
  { "metro", ALGO_KECCAKM, "", 1, 1, 1, 4, 15, 0x0F, 0xFFFFULL, 0x000000ffUL, 0, 0, CL_QUEUE_OUT_OF_ORDER_EXEC_MODE_ENABLE, metro_regenhash, NULL, NULL, queue_metro_kernel, keccak256, NULL },
